...
class MatrixClient(object):
    ...
    Usage (logged in):
        ...
        rooms = client.ss()  # NB: From initial sync
    ...
    def __init__(self, base_url, token=None, user_id=None, valid_cert_check=True, limit=50):
    ...
    def login_with_password(self, username, password, limit=20):
